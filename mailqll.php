...
if(isset($_REQUEST['pwdrst']))
{
  ...
  $check_email = mysqli_query($connection,"select admin_user,status from admin_acc where admin_user='$email'");
  ...
  if($res>0)
  {
    ...
    $message = '<div>
     ...
     <br>
     <p><button class="btn btn-primary"><a href="http://localhost/UQUIZ/quizermailpass.php?secret='.base64_encode($email).'">Reset Password</a></button></p>
     <br>
    </div>';
...
echo "<script>window.location.href='adminpanel/admin/index.php';</script>";
}
}
}
?>
