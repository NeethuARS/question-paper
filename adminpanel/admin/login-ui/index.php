			...
			<div class="wrap-login100">
				...
				<form method="post" id="adminLoginFrm" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100" type="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,16}$"  title="Must contain: 1 Upper case, 1 Lower case, 1 Digit, 1 Special Character, Atleast 8 Characters" name="pass" placeholder="Enter password">
						<span class="focus-input100"></span>
					</div>
