...
<div class="app-main__outer">
 ...
 ?>
                      ...
                      $i = 1;
               for($m=0;$m<$selQue['MARK2'];$m++) {
                for($n=0;$n<$selQue['M1L2'];$n++) {
                 $selQuest = $conn->query("SELECT * FROM questionanswers WHERE PID='$PID' AND MARKS=2 AND DIFFICULTY=2 ORDER BY rand()");
            if($selQuest->rowCount() > 0) {
              $selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC);
                ...
                <?php } else if($selQuestRow['QID']==2) {  ?>
                  ...
                  <?php } }  } } for($n=0;$n<$selQue['M1L1'];$n++) {
                 $selQuest = $conn->query("SELECT * FROM questionanswers WHERE PID='$PID' AND MARKS=2 AND DIFFICULTY=1 ORDER BY rand()");
            if($selQuest->rowCount() > 0) {
              $selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC);
                      if($selQuestRow['QID'] == 1) { 
                       ?>
                ...
                <?php } else if($selQuestRow['QID']==2) {  ?>
                  ...
                  <?php } }  } 
                   for($n=0;$n<$selQue['M1L3'];$n++) {
                 $selQuest = $conn->query("SELECT * FROM questionanswers WHERE PID='$PID' AND MARKS=2 AND DIFFICULTY=3 ORDER BY rand()");
            if($selQuest->rowCount() > 0) {
              $selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC);
                      if($selQuestRow['QID'] == 1) { 
                       ?>
                ...
                <?php } else if($selQuestRow['QID']==2) {  ?>
                  ...
                  <?php } }  } 
                  for($n=0;$n<$selQue['M1L4'];$n++) {
                 $selQuest = $conn->query("SELECT * FROM questionanswers WHERE PID='$PID' AND MARKS=2 AND DIFFICULTY=4 ORDER BY rand()");
            if($selQuest->rowCount() > 0) {
              $selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC);
                      if($selQuestRow['QID'] == 1) { 
                       ?>
                ...
                <?php } else if($selQuestRow['QID']==2) {  ?>
                  ...
                  <?php } }  } 
                  for($n=0;$n<$selQue['M1L5'];$n++) {
                 $selQuest = $conn->query("SELECT * FROM questionanswers WHERE PID='$PID' AND MARKS=2 AND DIFFICULTY=5 ORDER BY rand()");
            if($selQuest->rowCount() > 0) {
              $selQuestRow = $selQuest->fetch(PDO::FETCH_ASSOC);
                      if($selQuestRow['QID'] == 1) { 
                       ?>
