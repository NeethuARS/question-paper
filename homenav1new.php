...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="homenavnew1.css">
...
<body>
  <nav>
    <div class="navbar">
      <div class="logo"><h2 style="color: white">U-QUIZ</h2></a></div>
      <ul class="nav-links">
        <li><a href="mailqll.php">Quizer Login</a></li>
        <li><a href="mailstull.php">Student Login</a></li>
        <li><a href="adminpanel/admin/adlogin.php">Admin login</a></li>
        </ul>
  ...
  <section class="home-content">
    <div class="texts">
      <h2 class="text">welcome to quiz platform </h2>
      <h3 class="text"><span>provoke your knowledge </span></h3>
      <p>“There is no cramming for a test of character. It always comes as a pop quiz.”
        <br><span> ~ Andy Stanley</span>
</p>
