            ...
            <tbody>
              ...
              $i = 1;  
                ...
                for($r=1;$r<=$selQue1['MARK1'];$r++) {
                   ...
                   $selQuest1 = $conn->query("SELECT DISTINCT(QUEST_ID),MARKS,QUESTION_DESC,QID,CHOICE_1,CHOICE_2,CHOICE_3,CHOICE_4 FROM questionanswers WHERE MARKS=1 AND QUEST_ID not in ('".implode("', '", $usedQuest)."') ORDER BY rand()");
        ...
        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
         <table class="align-left mb-0 table table-borderless table-striped table-hover" id="tableList">
            ...
            <tbody>
              ...
              $i = 1;  
                $usedQuest = [];
                for($r=1;$r<=$selQue1['MARK2'];$r++) {

                   $selQuest1 = $conn->query("SELECT DISTINCT(QUEST_ID),MARKS,QUESTION_DESC,QID,CHOICE_1,CHOICE_2,CHOICE_3,CHOICE_4 FROM questionanswers WHERE MARKS=2 AND QUEST_ID not in ('".implode("', '", $usedQuest)."') ORDER BY rand()");
        ...
        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
         <table class="align-left mb-0 table table-borderless table-striped table-hover" id="tableList">
            ...
            <tbody>
              ...
              $i = 1;  
                $usedQuest = [];
                for($r=1;$r<=$selQue1['MARK3'];$r++) {

                   $selQuest1 = $conn->query("SELECT DISTINCT(QUEST_ID),MARKS,QUESTION_DESC,QID,CHOICE_1,CHOICE_2,CHOICE_3,CHOICE_4 FROM questionanswers WHERE MARKS=3 AND QUEST_ID not in ('".implode("', '", $usedQuest)."') ORDER BY rand()");
        ...
        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
         <table class="align-left mb-0 table table-borderless table-striped table-hover" id="tableList">
            ...
            <tbody>
              ...
              $i = 1;  
                $usedQuest = [];
                for($r=1;$r<=$selQue1['MARK5'];$r++) {

                   $selQuest1 = $conn->query("SELECT DISTINCT(QUEST_ID),MARKS,QUESTION_DESC,QID,CHOICE_1,CHOICE_2,CHOICE_3,CHOICE_4 FROM questionanswers WHERE MARKS=5 AND QUEST_ID not in ('".implode("', '", $usedQuest)."') ORDER BY rand()");
