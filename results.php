...
<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <form method="post" action="paperresult.php">
            <select class="form-control" name="papid">
              ...
              <?php 
                ...
                if($selCourse->rowCount() > 0)
                {
                  while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                     <option name=papid id=course value="<?php echo $selCourseRow['PID']; ?>"><?php echo $selCourseRow['PNAME']; ?></option>
                  <?php } 
                }
                else
                { ?>
            ...
            <div>
             <button name="send" class="btn btn-primary" style="width: 100%" class="btn btn-primary">Select</button>
             </div>
         </form>
</div>
</div>
